...
from projection import MLP, TransformerMapper
...
class ClipCaptionModel(nn.Module):
    ...
    def __init__(self, prefix_length: int, clip_length: Optional[int] = None, prefix_size: int = 576,
...
def main():
    ...
    prefix_dim = 640 if args.is_rn else 576
